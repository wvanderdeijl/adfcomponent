...
public class ItemDeleteEvent extends FacesEvent {
     ...
     */
    public ItemDeleteEvent(UIComponent source, String tag) {
        super(source);
        this.tag = tag;
    }
    ...
    public boolean isAppropriateListener(FacesListener facesListener) {
        return (facesListener instanceof ItemDeleteListener);
    }
    ...
    public void processListener(FacesListener facesListener) {
        ((ItemDeleteListener) facesListener).processItemDelete(this);
    }
